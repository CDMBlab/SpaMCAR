"""
ConSpaS — Contrastive Spatial Self-supervised Graph Autoencoder
...
from model.Train import train as ConSpaS_train
...
def main():
    ...
    args = argparse.Namespace(
        lr=0.001, knn=6, save_loss=False, device='cuda:0',
        verbose=True, weight_decay=0.0, n_epochs=500,
        temperature=0.5, seed=0,
    )
    adata = ConSpaS_train(adata, args)
    adata = mclust_R(adata, n_clusters, use_rep='latent')
    ...
    print(f"ConSpaS {sample}: ARI = {ARI:.4f}")
